<template>
  <div class="Description">
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        <div class="col">
          <h2>What does the SEO work involve?</h2>
          <p>
            An overview of the work (and expectant order of actions) involved in the search engine optimisation process we follow includes:</p>
          <h3>Initial Setup</h3>
          <p>
            Every website (that hasn’t had SEO work done before) starts off by enabling and installing tools to monitor / identify the current state and going forward the progress of the website’s keyword ranking. These tools allow a clearer view of how the changes made to the website have impacted the SEO as well as the subsequent benefits of doing so (e.g. increased visitors). With this we are also more than willing to help the website owners become familiar with using these tools to give them the ability to review the site themselves during and after we are working on it with them. </p>
          ...
          <p>
            After carrying out an analysis our findings will be presented to you in the most appropriate format depending on how much control you wish to have over the changes, some clients prefer we just get on with providing the service and are happy with the results. Others prefer to be more engrained in the process and provide their own flavour and style which will ultimately affect the outcome of the end product. We have found that both of these approaches have ups and downs but the outcome has always been in the benefit of the client utilising the SEO service we provide.</p>
