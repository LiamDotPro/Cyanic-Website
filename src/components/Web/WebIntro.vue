    ...
    <div class="container">
      ...
      <div class="row service-row service-row-boxed align-items-center">
        <div class="col">
          ...
          <div class="row process-row">
            <div class="col-lg-1 col-md-2 hidden-sm-down process-col-line">
              <div class="step-icon-block">
                <icon class="step-icon" name="list-ol" scale="2"></icon>
              </div>
            </div>
          ...
          <div class="row process-row">
            <div class="col-lg-1 col-md-2 hidden-sm-down process-col-line">
              <div class="step-icon-block">
                <icon class="step-icon" name="bullseye" scale="2"></icon>
              </div>
            </div>
            <div class="col-lg-11 col-md-10">
          ...
          <div class="row process-row">
            <div class="col-lg-1 col-md-2 hidden-sm-down process-col-line">
              <div class="step-icon-block">
                <icon class="step-icon" name="pencil" scale="2"></icon>
              </div>
            </div>
            <div class="col-lg-11 col-md-10">
          ...
          <div class="row process-row">
            <div class="col-lg-1 col-md-2 hidden-sm-down process-col-line">
              <div class="step-icon-block">
                <icon class="step-icon" name="flash" scale="2"></icon>
              </div>
            </div>
            <div class="col-lg-11 col-md-10">
          ...
          <div class="row process-row">
            <div class="col-lg-1 col-md-2 hidden-sm-down process-col-line">
              <div class="step-icon-block">
                <icon class="step-icon" name="code-fork" scale="2"></icon>
              </div>
            </div>
            <div class="col-lg-11 col-md-10">
          ...
          <div class="row process-row">
            <div class="col-lg-1 col-md-2 hidden-sm-down process-col-line">
              <div class="step-icon-block">
                <icon class="step-icon" name="heart" scale="2"></icon>
              </div>
            </div>
            <div class="col-lg-11 col-md-10">
          ...
          <div class="row process-row">
            <div class="col-lg-1 col-md-2 hidden-sm-down">
              <div class="step-icon-block">
                <icon class="step-icon" name="lightbulb-o" scale="2"></icon>
              </div>
            </div>
            <div class="col-lg-11 col-md-10">
      ...
      <div class="row service-row service-row-boxed align-items-center">
        ...
        <div class="col-lg-3 hidden-md-down">
          <img src="../../assets/icons/web/coffee-mug.png" class="img-fluid"
               alt="Web Design Derby and Reading Location Icon">
        </div>
      </div>
...
<style lang="scss" scoped>
  ...
  @media (max-width: 991px) {
    .WebIntro .service-row-boxed h2 {
      font-size: 1.5rem;
    }
    .WebIntro .row-location {
      background: #fff url(../../assets/img/services/location-background.jpg) no-repeat right -10% bottom;
    }
    .WebIntro .process-row {
      padding: 15px 0;
    }
  }
